                ...
                <li>
        			...
        			<div style="padding-top: 20px">
        				<form id="form1" action=""  method="post" enctype="multipart/form-data">
        					<input class="imgInput" type="file" name="uploadfile" value="选择照片" style="font-size: 20px">
        					<input id="imgsub" type="button" value="上传" style="font-size: 20px">
        				</form>
...
<jsp:include page="footer.jsp"></jsp:include>
   ...
   <script>  
      ...
      //上传身份证照片
      document.getElementById("imgsub").addEventListener('click',function(){  
                          $.ajax({
                          	type:'POST',
